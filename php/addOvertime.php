...
function insertRequest($userID, $groupID, $locationID, $projectID, $itemOfWorkID, $jobDescriptionID, $remarks, $duration, $requestDate) {
    global $connjmr;

    $insertRequest = "INSERT INTO `overtime_request` (`user_id`, `location_id`, `group_id`, `project_id`, `item_id`, `job_id`,
                        `duration`, `remarks`, `request_date`) 
                        VALUES (:userID, :locationID, :groupID, :projectID, :itemOfWorkID, :jobDescriptionID, :duration, :remarks, :requestDate)";
...
$insert = insertRequest($userID, $groupID, $locationID, $projectID, $itemOfWorkID, $jobDescriptionID, $remarks, $duration, $requestDate);
